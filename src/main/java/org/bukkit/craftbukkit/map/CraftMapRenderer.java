...
public class CraftMapRenderer extends MapRenderer {
    ...
    public void render(MapView map, MapCanvas canvas, Player player) {
        ...
        for (Object key : worldMap.decorations.keySet()) {
            ...
            cursors.addCursor(decoration.getX(), decoration.getY(), (byte) (decoration.getRotation() & 15), decoration.getTheType().a(), true, CraftChatMessage.fromComponent(decoration.getName()));
        }
    }
