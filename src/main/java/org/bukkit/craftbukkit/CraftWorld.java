...
public class CraftWorld implements World {
    ...
    public boolean isChunkGenerated(int x, int z) {
        try {
            return isChunkLoaded(x, z) || ((ChunkProviderServer) this.world.getChunkProvider()).playerChunkMap.read(new ChunkCoordIntPair(x, z)) != null;
    ...
    public Chunk[] getLoadedChunks() {
        Long2ObjectLinkedOpenHashMap<PlayerChunk> chunks = ((ChunkProviderServer) this.world.getChunkProvider()).playerChunkMap.visibleChunks;
    ...
    public boolean unloadChunkRequest(int x, int z) {
        ...
        if (chunk != null) {
            ((ChunkProviderServer) world.getChunkProvider()).removeTicket(TicketType.PLUGIN, chunk.getPos(), 1, Unit.INSTANCE);
        }
...
//        ((ChunkProviderServer) world.getChunkProvider()).purgeUnload();
    ...
    public boolean loadChunk(int x, int z, boolean generate) {
        ...
        if (chunk instanceof net.minecraft.server.Chunk) {
            ((ChunkProviderServer) world.getChunkProvider()).addTicket(TicketType.PLUGIN, new ChunkCoordIntPair(x, z), 1, Unit.INSTANCE);
            return true;
        }
    ...
    public boolean addPluginChunkTicket(int x, int z, Plugin plugin) {
        ...
        ChunkMapDistance chunkDistanceManager = ((ChunkProviderServer) this.world.getChunkProvider()).playerChunkMap.chunkDistanceManager;
    ...
    public <T extends AbstractArrow> T spawnArrow(Location loc, Vector velocity, float speed, float spread, Class<T> clazz) {
        ...
        if (TippedArrow.class.isAssignableFrom(clazz)) {
            ...
            ((io.github.fukkitmc.fukkit.extra.EntityTippedArrowExtra) arrow).setType(CraftPotionUtil.fromBukkit(new PotionData(PotionType.WATER, false, false)));
        ...
        if (Boat.class.isAssignableFrom(clazz)) {
            ...
            if (Snowball.class.isAssignableFrom(clazz)) {
                ...
                if (TippedArrow.class.isAssignableFrom(clazz)) {
                    ...
                    ((io.github.fukkitmc.fukkit.extra.EntityTippedArrowExtra) entity).setType(CraftPotionUtil.fromBukkit(new PotionData(PotionType.WATER, false, false)));
                } else if (SpectralArrow.class.isAssignableFrom(clazz)) {
    ...
    public boolean getAllowAnimals() {
        return ((ChunkProviderServer) world.getChunkProvider()).allowAnimals;
    }

    @Override
    public boolean getAllowMonsters() {
        return ((ChunkProviderServer) world.getChunkProvider()).allowMonsters;
    }
    ...
    public void setKeepSpawnInMemory(boolean keepLoaded) {
        ...
        BlockPosition chunkcoordinates = this.world.s_();
        if (keepLoaded) {
            ((ChunkProviderServer) world.getChunkProvider()).addTicket(TicketType.START, new ChunkCoordIntPair(chunkcoordinates), 11, Unit.INSTANCE);
        } else {
            // TODO: doesn't work well if spawn changed....
            ((ChunkProviderServer) world.getChunkProvider()).removeTicket(TicketType.START, new ChunkCoordIntPair(chunkcoordinates), 11, Unit.INSTANCE);
        }
    }
    ...
    public Location locateNearestStructure(Location origin, StructureType structureType, int radius, boolean findUnexplored) {
        ...
        BlockPosition nearest = ((ChunkProviderServer) getHandle().getChunkProvider()).getChunkGenerator().findNearestMapFeature(getHandle(), structureType.getName(), originPos, radius, findUnexplored);
