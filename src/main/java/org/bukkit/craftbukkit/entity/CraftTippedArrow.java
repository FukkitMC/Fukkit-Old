...
public class CraftTippedArrow extends CraftArrow implements Arrow {
    ...
    public boolean addCustomEffect(PotionEffect effect, boolean override) {
        ...
        ((io.github.fukkitmc.fukkit.extra.EntityTippedArrowExtra) getHandle()).refreshEffects();
        return true;
    }
    ...
    public void setBasePotionData(PotionData data) {
        ...
        ((io.github.fukkitmc.fukkit.extra.EntityTippedArrowExtra) getHandle()).setType(CraftPotionUtil.fromBukkit(data));
    }

    @Override
    public PotionData getBasePotionData() {
        return CraftPotionUtil.toBukkit(((io.github.fukkitmc.fukkit.extra.EntityTippedArrowExtra) getHandle()).getType());
    }
