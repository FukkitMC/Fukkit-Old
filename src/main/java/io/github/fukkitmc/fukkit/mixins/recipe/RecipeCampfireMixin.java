...
@Mixin(RecipeCampfire.class)
public abstract class RecipeCampfireMixin extends RecipeCooking implements IRecipeExtra {

    public RecipeCampfireMixin(Recipes<?> recipes, MinecraftKey minecraftKey, String string, RecipeItemStack recipeItemStack, ItemStack itemStack, float f, int i) {
