...
public abstract class FurnaceRecipeMixin extends RecipeCooking implements IRecipeExtra {

    public FurnaceRecipeMixin(Recipes<?> recipes, MinecraftKey minecraftKey, String string, RecipeItemStack recipeItemStack, ItemStack itemStack, float f, int i) {
