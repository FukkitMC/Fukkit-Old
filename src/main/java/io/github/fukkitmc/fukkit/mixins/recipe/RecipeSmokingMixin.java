...
@Mixin(RecipeSmoking.class)
public abstract class RecipeSmokingMixin extends RecipeCooking implements IRecipeExtra {

    public RecipeSmokingMixin(Recipes<?> recipes, MinecraftKey minecraftKey, String string, RecipeItemStack recipeItemStack, ItemStack itemStack, float f, int i) {
